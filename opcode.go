...
// in dash core and in most if not all other references and software related
// to handling DASHE scripts.
const (
	OP_0                   = 0x00 // 0
	...
	OP_SMALLINTEGER        = 0xfa // 250 - dash core internal
	OP_PUBKEYS             = 0xfb // 251 - dash core internal
	OP_UNKNOWN252          = 0xfc // 252
	OP_PUBKEYHASH          = 0xfd // 253 - dash core internal
	OP_PUBKEY              = 0xfe // 254 - dash core internal
	OP_INVALIDOPCODE       = 0xff // 255 - dash core internal
)
...
var opcodeArray = [256]opcode{
	...
	// Dash Core internal use opcode.  Defined here for completeness.
