...
// WitnessSignature creates an input witness stack for tx to spend DASHE sent
...
// SignatureScript creates an input signature script for tx to spend DASHE sent
