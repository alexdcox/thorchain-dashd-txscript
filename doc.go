// Copyright (c) The dash developers
// Use of this source code is governed by an ISC
// license that can be found in the LICENSE file.

/*
Package txscript implements the dash transaction script language.

A complete description of the script language used by dash can be found at
...
dash transaction scripts.

Script Overview

Dash transaction scripts are written in a stack-base, FORTH-like language.

The dash script language consists of a number of opcodes which fall into
...
The vast majority of Dash scripts at the time of this writing are of several
...
what conditions must be met in order to spend dashs.
